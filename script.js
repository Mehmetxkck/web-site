...
const products = [
    ...
    { id: 28, name: "Tuzsuz Dakota Çekirdek", price: 165, category: "kuruyemis", image: "images/tuzlu_çekirdek.jpg", description: "Fırınlanmış, tuz eklenmeden yapılan çekirdek, doğal lezzet.", weights: [1000, 750, 500, 250] },
    { id: 29, name: "Tuzlu Kabak Çekirdeği", price: 625, category: "kuruyemis", image: "images/tuzsuz_kabak.jpg", description: "Lezzetli ve tuzlu kabak çekirdekleri, besleyici ve enerji verici.", weights: [1000, 750, 500, 250] },
    ...
    { id: 33, name: "Karışık Meyve Aromalı Kuş Lokumu", price: 150, category: "sekerleme", image: "images/antep-fıstıklı-cezerye.jpg", description: "Farklı meyve aromalarıyla zenginleştirilmiş kuş lokumu.", weights: [1000, 750, 500, 250] },
